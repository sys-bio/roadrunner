...
\DoxyCodeLine{    \textcolor{keyword}{using} csr\_matrix\_set\_nz\_FnTy = rr::csr\_matrix *(*)(\textcolor{keywordtype}{int}, \textcolor{keywordtype}{int}, \textcolor{keywordtype}{double});}
\DoxyCodeLine{    \textcolor{keyword}{using} csr\_matrix\_get\_nz\_FnTy = rr::csr\_matrix *(*)(\textcolor{keywordtype}{int}, \textcolor{keywordtype}{int});}
\DoxyCodeLine{}
