...
const char* SetBoundarySpeciesInitConcentrationCodeGen::IndexArgName = "floatingSpeciesIndex";
...
const char* SetBoundarySpeciesInitAmountCodeGen::IndexArgName = "floatingSpeciesIndex";
