...
public:
	...
	*/
     ...
     */
    virtual int getGlobalParameterValues(size_t len, const size_t* indx,
            double *values);

    virtual int setGlobalParameterValues(size_t len, const size_t* indx,
            const double *values);

    virtual int getNumReactions();

    virtual int getReactionRates(size_t len, const size_t* indx,
                    double *values);
     ...
     *                returned boundary species amounts.
     */
    virtual int getCompartmentVolumes(size_t len, const size_t* indx,
            double *values);
    ...
    virtual string getFloatingSpeciesId(size_t);
    virtual int getBoundarySpeciesIndex(const string&);
    virtual string getBoundarySpeciesId(size_t);
     ...
     *                returned boundary species amounts.
     */
    virtual int getFloatingSpeciesAmounts(size_t len, size_t const *indx,
            double *values);

    virtual int getFloatingSpeciesAmountRates(size_t len, size_t const *indx,
            double *values);

    virtual int getFloatingSpeciesConcentrationRates(size_t len, size_t const *indx,
            double *values);
     ...
     *                returned boundary species amounts.
     */
    virtual int getFloatingSpeciesConcentrations(size_t len, size_t const *indx,
            double *values);
     ...
     *                returned boundary species amounts.
     */
    virtual int setFloatingSpeciesConcentrations(size_t len, size_t const *indx,
            double const *values);

    virtual int setFloatingSpeciesAmounts(size_t len, size_t const *indx,
            const double *values);
     ...
     *                returned boundary species amounts.
     */
    virtual int getBoundarySpeciesAmounts(size_t len, size_t const *indx,
            double *values);
     ...
     *                returned boundary species amounts.
     */
    virtual int getBoundarySpeciesConcentrations(size_t len, const size_t* indx,
            double *values);
     ...
     *                returned boundary species amounts.
     */
    virtual int setBoundarySpeciesConcentrations(size_t len, const size_t* indx,
            double const *values);
    ...
    /**
      ...
      *                returned boundary species amounts.
      */
     virtual int setBoundarySpeciesAmounts(size_t len, const size_t* indx,
             double const *values);
    ...
    virtual int getConservedMoietyValues(size_t len, const size_t* indx, double *values);
    virtual int setConservedMoietyValues(size_t len, const size_t* indx,
            const double *values);


    virtual int setCompartmentVolumes(size_t len, const size_t* indx,
            const double *values);
    ...
    virtual int setFloatingSpeciesInitConcentrations(size_t len, const size_t *indx,
            double const *values);

    virtual int getFloatingSpeciesInitConcentrations(size_t len, const size_t *indx,
            double *values);

    virtual int setFloatingSpeciesInitAmounts(size_t len, const size_t *indx,
                double const *values);

    virtual int getFloatingSpeciesInitAmounts(size_t len, const size_t *indx,
                    double *values);

    virtual int setCompartmentInitVolumes(size_t len, const size_t *indx,
                double const *values);

    virtual int getCompartmentInitVolumes(size_t len, const size_t *indx,
                    double *values);

    virtual int setGlobalParameterInitValues(size_t len, const size_t *indx,
                double const *values);

    virtual int getGlobalParameterInitValues(size_t len, const size_t *indx,
                    double *values);
...
public:
     ...
     */
    virtual int getEventTriggers(size_t len, const size_t *indx, unsigned char *eventState);
    ...
    inline size_t getEventBufferSize(uint event)
    {
     ...
     */
    int getRateRueRates(size_t len, const size_t* indx, double *values);
