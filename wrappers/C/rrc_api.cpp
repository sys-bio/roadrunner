...
RRCDataPtr rrcCallConv simulate(RRHandle handle)
{
	...
	if (false)
	{
		...
		rri->getSimulateOptions().loadSBMLSettings("C:/rr/source/roadrunner/models/sbml-test-suite/cases/semantic/model_editing/00020/00020-settings.txt");
		rri->simulate();
		RoadRunnerData resultData(rri);

		ofstream fs("C:/rr/source/roadrunner/models/sbml-test-suite/cases/semantic/model_editing/00020/00020-results.csv");
		fs << resultData;
		fs.close();
	}
